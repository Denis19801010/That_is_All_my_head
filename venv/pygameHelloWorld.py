...
# нанесени ена поверхность красного эллипла
pygame.draw.ellipse(windowSurface, RED, (300, 250, 40, 80), 1)

# нанесени ена поверхность фонового прямоугольника для текста
pygame.draw.rect(windowSurface, RED, (textRect.left-20, textRect.top-20, textRect.width+40, textRect.height+40))

# получение массива пикселов поверхности( в сааааамом низу справа один пиксель)
